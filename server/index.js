...
// ─────────────────────────────────────────────────────────────────────────────
const required = ['ADMIN_USERNAME', 'ADMIN_PASSWORD_HASH', 'JWT_SECRET', 'BOTS_ROOT_DIR'];
...
app.listen(PORT, () => {
  console.log(`[Server] Bot Panel running on port ${PORT} (${process.env.NODE_ENV || 'development'})`);
});
