    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
      <div className="bg-slate-800 border border-slate-700 rounded-xl w-full max-w-lg shadow-2xl">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-700">
          <h2 className="text-lg font-semibold text-slate-100">➕ Create New Bot</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="label">Bot Slug (unique ID) *</label>
              <input className="input" placeholder="my-bot" value={form.botID} onChange={set('botID')} required
          ...
          <div>
            ...
            <input className="input" placeholder="https://github.com/user/repo.git" value={form.repoUrl} onChange={set('repoUrl')} required />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input className="input" placeholder="index.js" value={form.startScript} onChange={set('startScript')} />
            </div>
          </div>
